...
### Package ManagerInstall-Package DMNSN.Core
### .NET CLIdotnet add package DMNSN.Core
### PackageReference<PackageReference Include="DMNSN.Core" Version="8.0.0" />
## ?? Quick Start
...
**Examples:**"TRUE".ParseBoolean();    // true
